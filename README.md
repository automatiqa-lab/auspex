...
In design, built in public under the [Automatiqa](https://automatiqa.io) lab. Architecture notes and build logs at [automatiqa.io/tag/build-log](https://www.automatiqa.io/tag/build-log/).
